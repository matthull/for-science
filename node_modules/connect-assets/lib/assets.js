  ...
  exports.cssCompilers = cssCompilers = {
    styl: {
      ...
      compileSync: function(sourcePath, source, helperContext) {
        ...
        libs.fluidity || (libs.fluidity = (function() {
          try {
            return require('fluidity');
          } catch (e) {
            return function() {
              return function() {};
            };
        ...
        libs.stylus(source, options).use(libs.bootstrap()).use(libs.nib()).use(libs.fluidity()).use(libs.bootstrap()).use(libs.stylusExtends).define('asseturl', function(url) {
